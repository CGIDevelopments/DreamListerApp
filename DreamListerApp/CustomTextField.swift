...
class CustomTextField: UITextField, UITextFieldDelegate {
    ...
    var textFont = UIFont(name: "American Typewriter", size: 15.0)
    ...
    override func draw(_ rect: CGRect) {
        ...
        if let phText = self.placeholder {
            self.attributedPlaceholder = NSAttributedString(string: phText, attributes: [NSForegroundColorAttributeName: UIColor(netHex: 0xEC81FF)])
        ...
        if let fnt = textFont {
            ...
            self.font = UIFont(name: "American Typewriter", size: 15.0)
        }
    }
